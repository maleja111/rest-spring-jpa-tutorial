...
<body>
	...
	<div class="main">
		<div class="container tim-container"
			...
			<c:url var="url"
				value="${request.contextPath}/aves/update/${editAves.id}" />


			<form:form class="form-horizontal" action="${url}" method="post"
				commandName="editAves">
				<fieldset>

					<!-- Form Name -->
					<legend>Editar Ave</legend>
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<form:input path="cdAve" class="form-control input-md" />
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<form:input path="dsNombreComun" class="form-control input-md" />
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<form:input path="dsNombreCientifico" class="form-control input-md" />
